...
const Template = (args) => ({
  ...
  template: `<div class="cla-template-wrapper"><AppHeader><template #app-link>${AppHeaderDefault.args.appslot}</template><template #navbar-links>${AppHeaderDefault.args.navslot}</template></AppHeader>
    <main class="tw-pb-4">
      <PostIt>${args.postitContent}</PostIt>
    </main>
